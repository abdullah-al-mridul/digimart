...
export const paymentController = async (req, res) => {
  try {
    ...
    const data = {
      ...
      success_url: `${process.env.API_BASE_URL}/api/v1/payment/success`,
      fail_url: `${process.env.API_BASE_URL}/api/v1/payment/fail`,
      cancel_url: `${process.env.API_BASE_URL}/api/v1/payment/cancel`,
      ipn_url: `${process.env.API_BASE_URL}/api/v1/payment/ipn`,
      shipping_method: "NO",
...
export const paymentSuccess = async (req, res) => {
  ...
  //     const data = {
  //       val_id: "67c895cfd5ebf5020efaf113",
  //     };
  ...
  //     //   });
  //     // }
  //     // const order = await Order.findById(req.query.val_id);
  //     const sslcz = new SSLCommerzPayment(store_id, store_passwd, is_live);
...
export const paymentFail = async (req, res) => {
  try {
    const order = await Order.findById(req.body.tran_id);
    if (order) {
